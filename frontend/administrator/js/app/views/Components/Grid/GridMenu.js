...
Ext.define("App.views.Components.Grid.GridMenu", {
	...
	init: function(grid) {
		...
		this.menu = new Ext.menu.Menu({
			...
			items: [{
				text: "Export",
				icon: App.getResourcePath() + 'resources/fugue-icons/icons/application-export.png',
				menu: [{
					...
					icon: App.getResourcePath() + 'resources/fugue-icons/icons/blue-document-excel.png',
					text: 'Export as Excel XML (.xlsx)',
					handler: this.exportXLSX,
					scope: this
				},{
					icon: App.getResourcePath() + 'resources/icons/mediawiki_icon.png',
