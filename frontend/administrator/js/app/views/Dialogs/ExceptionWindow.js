Ext.define('App.views.Dialogs.ExceptionWindow', {
    ...
    showException: function (exception, requestData) {
		if (!App.ExceptionWindow) {
    		App.ExceptionWindow = Ext.create('App.Dialog.ExceptionWindow');
    	}
		
		App.ExceptionWindow._showException(exception, requestData);
	},
    ...
    statics: {
    	...
    	showException: function (exception, requestData) {
    		if (!App.ExceptionWindow) {
        		App.ExceptionWindow = Ext.create('App.Dialogs.ExceptionWindow');
        	}
