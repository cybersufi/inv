Ext.define('App.views.Components.Groupdetail.GroupdetailDataView', {
	...
	initComponent: function () {
        ...
        this.nameSortButton = this.createSortButton('Name', 'membername');
